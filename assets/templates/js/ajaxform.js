...
var messageLive = 2000,
    $formPopup = $('.form-popup'),
    $formFade = $('.form-fade'),
    $formPopupWrap = $('.form-popup-wrap');

var successMessageShow = function () {
    $formPopup.add($formFade).removeClass('is-visible');
    $formPopupWrap.removeClass('is-flex');
    $('#jGrowl').addClass('is-flex');

    setTimeout(function () {
        $('#jGrowl').removeClass('is-flex');
    }, messageLive + 1000);
};

var errorMessageShow = function () {
    $('#jGrowl').addClass('is-flex');
